            ...
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    else if (IdProducto == "2")
                    {
                        ...
                        ReportParameter TipoDeSeguro= new ReportParameter();                        
                        if (Lista[0].TipoSeguro == "2")// hdnProductoId.Value == "2"
                        {
                        ...
                        if (Lista[0].TipoSeguro == "2")// hdnProductoId.Value == "2"
                        {
                            Beneficiario = new ReportParameter("Beneficiario", Lista[0].Beneficiario);
                            Asegurado = new ReportParameter("Asegurado", Lista[0].Asegurado);
                            TipoAsegurado = new ReportParameter("TipoAsegurado", String.Format("ASEGURADO ({0})        :", Lista[0].TipoPadre.ToUpper()));
                        }
                        //else 
                        if (Lista[0].TipoSeguro == "1")
                        {
